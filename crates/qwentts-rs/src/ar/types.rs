...
pub struct ArConfig {
    ...
    pub code_pred_hidden_size: u32,
    pub code_pred_intermediate_size: u32,
    pub code_pred_attention_heads: u32,
    pub code_pred_key_value_heads: u32,
    pub code_pred_head_dim: u32,
...
pub enum ArTensorRole {
    ...
    CodePredInputProjWeight,
    CodePredInputProjBias,
